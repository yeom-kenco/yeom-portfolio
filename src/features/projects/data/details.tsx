      ...
      },
      {
        ...
        groups: [
          ...
          },
          {
            ...
            items: [
              <>
                복잡한 달력 라이브러리 없이도 Embla + date-fns + React 조합으로 경량 날짜 스트립
                컴포넌트를 직접 설계·구현했다.
              </>,
              <>
                실제 서비스에서 중요한 날짜 선택 경험을 “오늘 기준 7일”이라는 강한 컨텍스트와 함께
                제공하여, 유저가 빠르게 예약 결정을 내릴 수 있는 흐름을 만들었다.
              </>,
              <>
                월 경계, 과거 날짜, 교차-월과 같은 엣지 케이스를 치밀하게 처리함으로써 기능 구현뿐
                아니라 UX·디테일·안정성까지 고려한 개발 경험을 쌓았다.
              </>,
            ],
          },
        ],
